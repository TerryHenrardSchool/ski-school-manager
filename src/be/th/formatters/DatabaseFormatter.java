...
public class DatabaseFormatter {
    ...
    private static final String BELGIAN_DATETIME_PATTERN = "dd/MM/yyyy HH:mm";
    ...
    private static final DateTimeFormatter BELGIAN_DATETIME_FORMATTER = DateTimeFormatter.ofPattern(BELGIAN_DATETIME_PATTERN);
    ...
    public static String toBelgianFormat(LocalDateTime dateTime) {
        return dateTime.format(BELGIAN_DATETIME_FORMATTER);
    }
}
